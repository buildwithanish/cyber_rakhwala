          ...
          <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
            ...
            >
              <div className="relative">
                ...
                <div className="relative w-12 h-12 rounded-2xl overflow-hidden border border-cyan-400/50 shadow-lg shadow-cyan-500/30">
                  <img src="/images/cr-logo.png" alt="CR Logo" className="w-12 h-12 object-contain" />
                </div>
              </div>
              <div>
                <h1 className="text-xl font-black tracking-tight" style={{ fontFamily: 'Papyrus, fantasy' }}>
