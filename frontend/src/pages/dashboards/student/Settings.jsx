...
import {
  ...
  ToggleLeft, ToggleRight, Zap, Activity, Clock, Database, Wifi, Terminal
} from 'lucide-react';
...
const Settings = () => {
  ...
  const [accountSettings, setAccountSettings] = useState({
    email: user?.email || 'agent@cyberrakhwala.com',
    displayName: user?.name || 'Cyber Agent',
    username: user?.username || 'cyber_agent_001',
    phone: '+91 XXXXXX1234',
          ...
          >
            ...
            >
              ...
              <div className="flex gap-3 mt-6">
                ...
                <button
                  onClick={() => { setShowPasswordModal(false); setSaved(true); setTimeout(() => setSaved(false), 3000); }}
                  className="flex-1 px-4 py-2 rounded-lg bg-cyan-500 text-black font-medium hover:bg-cyan-400"
                >
                  Update Password
                </button>
              </div>
