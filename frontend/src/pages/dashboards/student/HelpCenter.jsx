...
const HelpCenter = () => {
  ...
  const [chatMessages, setChatMessages] = useState([
    { id: 1, type: 'bot', message: 'Hello! I\'m your Cyber Rakhwala assistant. How can I help you today?' }
  ]);
  ...
  const tutorials = [
    { id: 1, title: 'Getting Started with Cyber Rakhwala', duration: '5 min', level: 'Beginner', icon: '🚀', description: 'Learn the basics of navigation and your first investigation' },
