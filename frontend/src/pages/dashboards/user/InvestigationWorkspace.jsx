...
import {
  ...
  Fingerprint, CreditCard, BarChart3, Network, Users
} from 'lucide-react';
...
const InvestigationWorkspace = () => {
  ...
  const tools = [
    ...
    { id: 'email', name: 'Email Forensics', icon: Mail, category: 'OSINT', cost: 12, color: 'from-green-500 to-emerald-500' },
    ...
    { id: 'image', name: 'Image EXIF', icon: Image, category: 'Forensics', cost: 15, color: 'from-orange-500 to-red-500' },
    ...
    { id: 'aadhaar', name: 'Aadhaar Info', icon: Fingerprint, category: 'Identity', cost: 20, color: 'from-red-500 to-orange-600' },
    { id: 'pan', name: 'PAN Lookup', icon: CreditCard, category: 'Financial', cost: 18, color: 'from-emerald-500 to-green-600' },
    { id: 'cdr', name: 'CDR Analysis', icon: BarChart3, category: 'Telecom', cost: 25, color: 'from-purple-500 to-violet-600' },
    { id: 'ipdr', name: 'IPDR Analysis', icon: Network, category: 'Telecom', cost: 25, color: 'from-cyan-500 to-teal-600' },
    { id: 'person', name: 'Person Location', icon: Users, category: 'Records', cost: 20, color: 'from-orange-500 to-amber-600' },
  ];
