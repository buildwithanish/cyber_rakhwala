...
const tools = [
  ...
  { id: 'email', name: 'Email Forensics', icon: Mail, color: 'cyan', path: '/dashboard/user/tools/email-forensics' },
  ...
  { id: 'exif', name: 'Image EXIF', icon: Image, color: 'violet', path: '/dashboard/user/tools/image-exif' },
];
