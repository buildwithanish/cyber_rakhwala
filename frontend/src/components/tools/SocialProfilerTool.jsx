  ...
  const handleSearch = async () => {
    ...
    setTimeout(() => {
      const resultData = {
        ...
        totalFound: 6,
        profiles: [
          { platform: 'Instagram', found: true, followers: '12.5K', posts: 342, verified: false, url: '#', color: '#E4405F', icon: Globe },
          { platform: 'Twitter', found: true, followers: '8.2K', posts: 1567, verified: true, url: '#', color: '#1DA1F2', icon: Globe },
          { platform: 'LinkedIn', found: true, followers: '2.1K', posts: 89, verified: true, url: '#', color: '#0A66C2', icon: Globe },
          { platform: 'GitHub', found: true, followers: '456', posts: 127, verified: false, url: '#', color: '#181717', icon: Globe },
          { platform: 'Facebook', found: false, followers: '-', posts: '-', verified: false, url: null, color: '#1877F2', icon: Globe },
          { platform: 'YouTube', found: true, followers: '3.4K', posts: 45, verified: false, url: '#', color: '#FF0000', icon: Globe },
          { platform: 'TikTok', found: true, followers: '25.1K', posts: 234, verified: true, url: '#', color: '#000000', icon: Camera },
          { platform: 'Reddit', found: false, followers: '-', posts: '-', verified: false, url: null, color: '#FF4500', icon: MessageCircle },
        ],
        aggregateStats: {
          totalFollowers: '51.7K',
          totalPosts: '2,404',
          avgEngagement: '4.2%',
          accountAge: '5 years',
        ...
        recentActivity: [
          { platform: 'Twitter', action: 'Posted', time: '2h ago', content: 'Just launched my new project!' },
          { platform: 'Instagram', action: 'Story', time: '5h ago', content: 'Behind the scenes...' },
          { platform: 'LinkedIn', action: 'Article', time: '1d ago', content: 'Top 10 Tech Trends for 2025' },
          { platform: 'GitHub', action: 'Commit', time: '3h ago', content: 'Fix: authentication bug' },
        ],
        riskIndicators: {
          privateMode: false,
      ...
      toast.success('Social profiles found!');
