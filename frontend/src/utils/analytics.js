...
export const initAnalytics = () => {
  ...
  flushInterval = window.setInterval(flushEvents, BATCH_INTERVAL);
  ...
  routeTrackerInterval = window.setInterval(() => {
...
export const disableAnalytics = () => {
  ...
  if (routeTrackerInterval) {
    window.clearInterval(routeTrackerInterval);
    routeTrackerInterval = null;
  }
};
